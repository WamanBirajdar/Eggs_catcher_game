...
c.create_rectangle(-5,canvas_height - 100, canvas_width + 5,canvas_width + 5, fill='sea green', width=0 )
c.create_oval(-80,-80,120,120,fill='orange',width=0)

color_cycle=cycle(['red','green','light blue','light pink','light yellow','light green','indigo','violet','orange'])
egg_width= 45
egg_height=35
egg_score=10
egg_speed=500
...
#it is all about cathcer
catcher=c.create_arc(catcher_start_x,catcher_start_y,catcher_start_x2,catcher_start_y2, start=200,extent=140, style='arc', outline='black',width=5)
